...
<!-- include libraries(jQuery, bootstrap) -->
    ...
    <!-- timepicker-->
    <c:import url="/resources/css/groupbuy/tui-time-picker.css" />
    <c:import url="/resources/js/groupbuy/./tui-time-picker.js" />
    <!-- datepicker-->
    <c:import url="/resources/css/groupbuy/tui-date-picker.css" />
    <c:import url="/resources/js/groupbuy/tui-code-snippet.js" />
    <c:import url="/resources/js/groupbuy/tui-date-picker.js" />
    
    <!-- 페이지css-->
    <c:import url="/resources/css/groupbuy/gb_update.css" />
