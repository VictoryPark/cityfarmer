  ...
  <html>
                ...
                <body>
                    ...
                    <div class="top-section">
                        <div class="main-image"><img src="<c:url value ="/img/tip/img/123.jpg"/>" width="1200" height="300" /></div>
                        <div class="main-title">
                            <h3>꿀팁 게시판<button type="button" class="btn btn-default pull-right"><a href="<c:url value="/tip/writeBoard.cf"/>">글쓰기</a></button></h3>  
